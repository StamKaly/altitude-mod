...
class Change:
    ...
    def handle(self, restart):
        start = '<?xml version="1.0" encoding="UTF-8"?>\n<ServerLauncherConfig ip="" upnpEnabled="true" updatePort="27275">\n  <servers>\n    <AltitudeServerConfig port="27279" downloadMaxKilobytesPerSecond="500" downloadHttpSource="" serverName="Stam and Tolis\' Academy testing server" maxPlayerCount="30" hardcore="true" autoBalanceTeams="false" preventTeamSwitching="true" disableBalanceTeamsPopup="true" lanServer="false" callEndOfRoundVote="true" disallowDemoUsers="false" rconEnabled="true" rconPassword="staftw" maxPing="1000" minLevel="0" maxLevel="0" secretCode="testing" cameraViewScalePercent="100">\n      <adminsByVaporID>\n'
        admins = ""
        maps = ""
